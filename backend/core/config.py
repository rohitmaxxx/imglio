...
class Settings:
    ...
    # Comma-separated list. Defaults to production; override with FRONTEND_ORIGIN
    # (e.g. "http://localhost,http://localhost:3000") for local Docker dev.
    FRONTEND_ORIGINS: list[str] = [
        origin.strip()
        for origin in os.environ.get("FRONTEND_ORIGIN", "https://pixanzo.com,https://www.pixanzo.com").split(",")
        if origin.strip()
    ]
